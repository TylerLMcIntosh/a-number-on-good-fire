...
rasterForVizF <- "gf_data_flatraster_california_2010_2020.tif" # The name of the visualization raster in GDrive that you want to use for case study pull out
...
gfData <- readr::read_csv(here::here('data', 'derived', 'gf_data_combined_states_welty_wildfire_2010_2020.csv'))
...
gfSpatial <- sf::st_read(here::here(derivedDatDir, 'merged_goodfire_final_states_welty_wildfire.gpkg')) |>
  sf::st_transform(sf::st_crs(epsg))
...
frg5lowmix = sum(gfData$frg5GoodLowMod)
frg5high = sum(gfData$frg5GoodHigh)
frg5lowmix/(frg5high + frg5lowmix)
